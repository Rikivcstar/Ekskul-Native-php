...
// Ambil daftar ekstrakurikuler yang diikuti
$eskul_list = query("
                        ...
                        <div class="card border-0 shadow-sm mt-3">
                            ...
                            <div class="card-body">
                                <p class="small text-muted mb-3">
                                    <i class="bi bi-info-circle"></i> Cetak kartu anggota ekstrakurikuler Anda
                                </p>
                                <?php while ($eskul = $eskul_list->fetch_assoc()): ?>
                                <div class="mb-2">
                                    <a href="<?php echo BASE_URL; ?>siswa/cetak_kartu.php?id=<?php echo $eskul['id']; ?>" 
                                       class="btn btn-sm btn-outline-success w-100" 
                                       target="_blank">
                                        <i class="bi bi-printer"></i> Cetak Kartu <?php echo $eskul['nama_ekskul']; ?>
                                    </a>
                                </div>
                                <?php endwhile; ?>
                            </div>
