...
<nav class="pc-sidebar">
  <div class="navbar-wrapper">
    <div class="m-header">
      <a href="<?php echo BASE_URL; ?>admin/dashboard.php" class="b-brand text-primary d-flex align-items-center">
        <img src="<?php echo BASE_URL; ?>assets/images/logo MTSN1.png" alt="Logo Mtsn Lebak" width="50" class="img-fluid p-1 mt-3">
        <h4 class= "mt-4 mx-2" >SIK MTSN 1 LEBAK</h2>
      </a>
      <button type="button" class="btn-close-sidebar" aria-label="Close sidebar" id="sidebar-close">
        <i class="ti ti-x"></i>
      </button>
    </div>
  ...
  <li class="pc-item pc-trigger <?= 
      ...
      strpos($_SERVER['PHP_SELF'],'/admin/eskul/')!==false 
      ? 'active' : '' ?>">
    ...
    <ul class="pc-submenu">
      <li class="pc-item <?= strpos($_SERVER['PHP_SELF'],'/admin/users/')!==false?'active':'' ?>">
        <a href="<?= BASE_URL ?>admin/users/index.php" class="pc-link">Users</a>
      </li>
      <li class="pc-item <?= strpos($_SERVER['PHP_SELF'],'/admin/anggota/')!==false?'active':'' ?>">
        <a href="<?= BASE_URL ?>admin/anggota/manage.php" class="pc-link">Anggota</a>
      </li>
      <li class="pc-item <?= strpos($_SERVER['PHP_SELF'],'/admin/eskul/')!==false?'active':'' ?>">
        <a href="<?= BASE_URL ?>admin/eskul/index.php" class="pc-link">Ekstrakurikuler</a>
      </li>
    </ul>
  </li>
  ...
  <li class="pc-item pc-trigger <?=
      ...
      strpos($_SERVER['PHP_SELF'],'/admin/presensi/')!==false 
      ? 'active' : '' ?>">
    ...
    <ul class="pc-submenu">
      <li class="pc-item <?= strpos($_SERVER['PHP_SELF'],'/admin/jadwal/')!==false?'active':'' ?>">
        <a href="<?= BASE_URL ?>admin/jadwal/index.php" class="pc-link">Jadwal</a>
      </li>
      <li class="pc-item <?= strpos($_SERVER['PHP_SELF'],'/admin/presensi/')!==false?'active':'' ?>">
        <a href="<?= BASE_URL ?>admin/presensi/index.php" class="pc-link">Presensi</a>
      </li>
    </ul>
  </li>
  ...
  <li class="pc-item pc-trigger <?= 
      ...
      strpos($_SERVER['PHP_SELF'],'/admin/prestasi/')!==false 
      ? 'active' : '' ?>">
    ...
    <ul class="pc-submenu">
      <li class="pc-item <?= $current_script==='penilaian_siswa.php'?'active':'' ?>">
        <a href="<?= BASE_URL ?>admin/penilaian_siswa.php" class="pc-link">
          Penilaian Siswa
      ...
      <li class="pc-item <?= strpos($_SERVER['PHP_SELF'],'/admin/prestasi/')!==false?'active':'' ?>">
        <a href="<?= BASE_URL ?>admin/prestasi/index.php" class="pc-link">Prestasi</a>
      </li>
    </ul>
  </li>
  ...
  <li class="pc-item pc-trigger <?= 
      ...
      strpos($_SERVER['PHP_SELF'],'/admin/galeri/')!==false 
      ? 'active' : '' ?>">
    ...
    <ul class="pc-submenu">
      <li class="pc-item <?= strpos($_SERVER['PHP_SELF'],'/admin/berita/')!==false?'active':'' ?>">
        <a href="<?= BASE_URL ?>admin/berita/manage.php" class="pc-link">Berita</a>
      </li>
      <li class="pc-item <?= strpos($_SERVER['PHP_SELF'],'/admin/galeri/')!==false?'active':'' ?>">
        <a href="<?= BASE_URL ?>admin/galeri/index.php" class="pc-link">Galeri</a>
      </li>
    </ul>
  </li>
  ...
  <div class="header-wrapper">
    <div class="me-auto">
      <ul class="list-unstyled m-0 d-flex align-items-center gap-2">
        ...
        <li class="pc-h-item flex-grow-1">
          <div class="header-search">
            <i class="ti ti-search search-icon"></i>
            <input type="search" placeholder="Search here..." />
            <a href="#" class="filter-pill" aria-label="Filter"><i class="ti ti-adjustments-horizontal"></i></a>
          </div>
        </li>
      </ul>
    </div>
